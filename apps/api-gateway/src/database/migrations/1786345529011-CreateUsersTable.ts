...
export class CreateUsersTable1786345529011 implements MigrationInterface {
  name = 'CreateUsersTable1786345529011';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'staff', 'user')`,
    );
    await queryRunner.query(
