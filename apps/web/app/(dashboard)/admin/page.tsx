    ...
    <RoleRoute roles={['ADMIN', 'admin']}>
      <Page>
        <PageHeader
          ...
          description="Real-time control center for staff management, clinical appointments, system liveness, and audit compliance."
          actions={
        ...
        <div className="mt-6 grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="bg-card p-4 rounded-xl border border-border/80 shadow-xs flex items-center justify-between">
            <div>
              ...
              <h3 className="text-xl font-bold text-emerald-500 mt-1 flex items-center gap-1.5">
                <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
                Operational
              </h3>
              <p className="text-[11px] text-muted-foreground mt-0.5">Liveness: 200 OK</p>
            </div>
            <div className="w-10 h-10 rounded-lg bg-emerald-500/10 text-emerald-500 flex items-center justify-center">
          ...
          <div className="bg-card p-4 rounded-xl border border-border/80 shadow-xs flex items-center justify-between">
            <div>
              ...
              <h3 className="text-xl font-bold text-foreground mt-1 flex items-center gap-1">
                <ShieldCheck className="w-4 h-4 text-primary" /> Active
              </h3>
              <p className="text-[11px] text-muted-foreground mt-0.5">
                Correlation Interceptor ON
              </p>
            </div>
        ...
        {/* Feature Cards Grid (Upgraded from Coming Soon Placeholders) */}
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="hover:border-primary/50 transition-colors duration-200">
            ...
            <CardBody className="pt-4 space-y-4">
              <p className="text-xs text-muted-foreground leading-relaxed">
                Configure hospital appointment windows, review security correlation audit
                logs, and monitor infrastructure health.
              </p>

              <div className="bg-muted/30 p-3 rounded-lg border border-border/40 space-y-1.5 text-xs">
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Audit Interceptor:</span>
                  <span className="font-semibold text-emerald-500">Enabled</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Correlation Tracing:</span>
                  <span className="font-semibold text-foreground">UUIDv4</span>
                </div>
              </div>
